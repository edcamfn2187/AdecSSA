...
const supabaseUrl: string = (typeof import.meta !== 'undefined' && meta.env?.VITE_SUPABASE_URL) 
  ? String(meta.env.VITE_SUPABASE_URL)
  : 'https://yfeqddbvvhioyllkcnca.supabase.co';

const supabaseKey: string = (typeof import.meta !== 'undefined' && meta.env?.VITE_SUPABASE_ANON_KEY) 
